...
def main():
    ...
    print("Trying to build coverage target in directory: " + args.build_path + " Target: " + args.target)
    ...
    #os.system("lcov --remove coverage.info '/home/conan/.conan/*' --output-file coverage.info")
